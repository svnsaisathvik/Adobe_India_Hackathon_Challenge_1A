...
class ModifiedPDFOutlineExtractor:
    ...
    def process_directory(self, input_dir="sample_dataset_1/pdfs", output_dir="sample_dataset_1/outputs"):
...
def main():
    ...
    # Always process /app/input and /app/output for Docker evaluation
